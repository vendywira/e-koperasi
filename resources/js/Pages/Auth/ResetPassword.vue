...
<template>
    <Head title="Reset Password — CMS Admin" />
    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 via-white to-primary-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 px-4">
        ...
        <div class="relative w-full max-w-md">
                ...
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            type="email"
                            readonly
                            class="w-full px-4 py-2.5 text-sm bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-neutral-500 dark:text-neutral-400 cursor-not-allowed"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input
                                ...
                                :class="form.errors.password ? 'border-red-300 dark:border-red-700' : ''"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <button
                                ...
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-neutral-400 hover:text-neutral-600 dark:hover:text-neutral-300 transition-colors"
                            >
                                <svg v-if="!showPasswordConfirm" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <svg v-else class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
            ...
            <p class="text-center mt-6 text-sm text-neutral-500 dark:text-neutral-400">
                <a href="/login" class="text-primary-600 dark:text-primary-400 hover:underline font-medium">← Kembali ke login</a>
            </p>
        </div>
    </div>
</template>
