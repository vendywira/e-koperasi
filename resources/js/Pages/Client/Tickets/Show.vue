    ...
    <ClientLayout :title="'Ticket #' + ticket.ticket_number">
        ...
        <div class="h-screen bg-neutral-50 dark:bg-neutral-950 flex flex-col overflow-hidden">
            ...
            <div class="flex-1 flex flex-col min-h-0">
                <div class="overflow-y-auto flex-1 px-3 sm:px-6 lg:px-8 py-4 max-w-4xl mx-auto w-full">
                    <div class="space-y-3">
                        <!-- Status Bar -->
                ...
                <div class="shrink-0 px-3 sm:px-6 lg:px-8 pb-4 max-w-4xl mx-auto w-full">
